...
def upgrade():
    ...
    sa.Column('name', sa.VARCHAR(length=128), nullable=True),
    sa.Column('email', sa.VARCHAR(length=64)),
    sa.Column('tel', sa.VARCHAR(length=64)),
    sa.Column('location', sa.VARCHAR(length=64)),
    sa.Column('website', sa.VARCHAR(length=64)),
    sa.Column('profiles', sa.VARCHAR(length=8192)),
    sa.Column('description', sa.VARCHAR(length=32768)),
    sa.Column('awards', sa.VARCHAR(length=32768)),
    sa.Column('picture', sa.VARCHAR(length=256)),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
