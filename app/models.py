...
def init ():
    ...
    """ CEOs """
    AlexTsvetanov = User (username='AlexTsvetanov', company=Headstarter, email='alex@alexts.tk', password_hash=crypto('sample password'))
