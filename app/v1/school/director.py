...
class Director:
    ...
    @staticmethod
    def homepage():
        return render_template('core/' + str(session['language'] or get_locale()) + '/' + Director.folder() + '/index.html',
                               tags=Tag.query.all(),
    ...
    def offer_details(id):
        try:
            return render_template('core/' + str(session['language'] or get_locale()) + '/' + Director.folder() + '/offer-details.html',
    ...
    def company_view(id):
        ...
        return render_template('core/' + str(session['language'] or get_locale()) + '/visitor/company-page.html', company=company, 
