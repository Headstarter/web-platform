...
class Companies:
	...
	@staticmethod
	def homepage():
		return render_template('core/company/index.html',
								tags=Tag.query.all(),
	...
	def post_offer():
		if request.method == 'GET':
			return render_template('core/company/post-offer.html', positionId=-1, tags=Tag.query.all())
		else:
			import sys
			print('\n\n' + str(dict(request.form)) + '\n\n', file=sys.stderr)
			positionId = -1
	...
	def edit_offer(positionId):
		...
		print('\n\n', curr_position, '\n\n', file=sys.stderr)
		if request.method == 'GET':
			return render_template('core/company/post-offer.html', positionId=positionId, tags=Tag.query.all(), position=curr_position)
		else:
			import sys
			print('\n\n' + str(dict(request.form)) + '\n\n', file=sys.stderr)
			positionId = update_position(
	...
	def list_my_offers():
		...
		return render_template('core/company/list_offers.html',
							   tags=Tag.query.all(),
	...
	def profile():
		...
		return render_template('core/company/profile.html', company=company)
#"""
#	@staticmethod
#	def create_offer():
