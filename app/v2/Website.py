...
routes.add_url_rule('/media/<id>'                 , endpoint='media'             , view_func=lambda id: Website.get_website().media(id)             , methods=['GET'        ])
routes.add_url_rule('/about'                      , endpoint='about'             , view_func=lambda   : Website.get_website().about()               , methods=['GET'        ])
routes.add_url_rule('/blog/posts/<id>'            , endpoint='blog_posts'        , view_func=lambda id: Website.get_website().blog_posts(id)        , methods=['GET'        ])
...
routes.add_url_rule('/positions/<id>'             , endpoint='position_details'  , view_func=lambda id: Website.get_website().position_details(id)  , methods=['GET'        ])
...
routes.add_url_rule('/positions/<id>/edit'        , endpoint='edit_position'     , view_func=lambda id: Website.get_website().edit_position(id)     , methods=['GET', 'POST'])
...
routes.add_url_rule('/profile/<id>/cv'            , endpoint='view_cv'           , view_func=lambda id: Website.get_website().view_cv(id)           , methods=['GET'        ])
routes.add_url_rule('/company/<id>'               , endpoint='company_preview'   , view_func=lambda id: Website.get_website().company_preview(id)   , methods=['GET'        ])